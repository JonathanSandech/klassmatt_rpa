...
echo ==========================================
echo [MONITOR] Iniciando main.py - tentativa !attempt!
...
echo.
echo [MONITOR] main.py saiu com codigo: !exit_code! em %date% %time%

if !exit_code! equ 0 (
    echo [MONITOR] main.py finalizou com sucesso. Encerrando.
    goto :end
)
